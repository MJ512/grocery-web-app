...
export default function Navbar({ setSearchQuery }) {
  ...
  return (
    <nav className="bg-gradient-to-r from-blue-400 to-blue-500 p-4 shadow-lg">
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link to={"/"}>
            <div className="text-2xl font-bold flex items-center gap-2 text-white"><ShoppingBasket/>MERN</div>
          </Link>
